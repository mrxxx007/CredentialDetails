...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        addColumnButton.setIcon(new ImageIcon(getClass().getResource("/images/add-icon_x19.png")));
        ...
        removeColumnButton.setIcon(new ImageIcon(getClass().getResource("/images/remove-icon_x19.png")));
        ...
        moveUpButton.setIcon(new ImageIcon(getClass().getResource("/images/up-icon_x19.png")));
        ...
        moveDownButton.setIcon(new ImageIcon(getClass().getResource("/images/down-icon_x19.png")));
